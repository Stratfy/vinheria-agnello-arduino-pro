...
#include <Keypad.h>  // Inclusão da biblioteca necessária
...
const int velocidade = 20;    // Velocidade da animação de texto (em milissegundos)
short int menuatual = 0, opcao = 0;  // Índices para controle de menu e opção atual
 
// Constantes para controle de navegação por setas no menu
#define SETABAIXO 1
#define SETACIMA 2
#define SETAS 0
#define BUZZER 5  // Pino conectado ao buzzer

#define DHTpin 4
#define DHTmodel DHT22
//====================== INICIALIZAÇÃO DE DISPOSITIVOS DO SEU PROJETO ======================
//---------------------- FUNÇÃO: dht ----------------------
// Função definida no sistema. Veja a implementação para detalhes.
// Parâmetros: DHTpin, DHTmodel
//-----------------------------------------------------------
DHT dht(DHTpin, DHTmodel);  // Instancia o sensor de temperatura e umidade DHT22

#define LDR A0
 
RTC_DS1307 rtc;  // Instancia do módulo de relógio em tempo real
 
//---------------------- FUNÇÃO: lcd ----------------------
// Função definida no sistema. Veja a implementação para detalhes.
// Parâmetros: 0x27, 16, 2
//-----------------------------------------------------------
LiquidCrystal_I2C lcd(0x27, 16, 2);  // Inicializa o display LCD 16x2 com endereço I2C
...
Keypad kpd = Keypad(makeKeymap(keys), rowPins, colPins, ROWS, COLS);  // Inicialização do teclado matricial 4x4
 
//====================== ANIMAÇÕES EM SPRITES ======================
const byte anim_aranha[2][4][8] PROGMEM = {  // Animações da aranha armazenadas na memória PROGMEM
  { 
...
//---------------------- FUNÇÃO: anim_carregar_sprites_pose ----------------------
// Função definida no sistema. Veja a implementação para detalhes.
// Parâmetros: byte pose
//-----------------------------------------------------------
...
//---------------------- FUNÇÃO: anim_desenhar_aranha ----------------------
// Função definida no sistema. Veja a implementação para detalhes.
// Parâmetros: byte col_esq
//-----------------------------------------------------------
...
//====================== FUNÇÕES AUXILIARES ======================
//---------------------- FUNÇÃO: anim_desenhar_texto ----------------------
// Função definida no sistema. Veja a implementação para detalhes.
//-----------------------------------------------------------
void anim_desenhar_texto() {  // Função auxiliar definida pelo usuário
...
//====================== FUNÇÕES AUXILIARES ======================
//---------------------- FUNÇÃO: anim_executar_inicializacao ----------------------
// Função definida no sistema. Veja a implementação para detalhes.
//-----------------------------------------------------------
void anim_executar_inicializacao() {  // Função auxiliar definida pelo usuário
...
//====================== FUNÇÕES AUXILIARES ======================
//---------------------- FUNÇÃO: restaurarConfiguracoesDeFabrica ----------------------
// Restaura os valores padrão do sistema e limpa a EEPROM.
//-----------------------------------------------------------
void restaurarConfiguracoesDeFabrica() {  // Função auxiliar definida pelo usuário
...
//---------------------- FUNÇÃO: print16 ----------------------
// Exibe informações no display LCD com base nos parâmetros de entrada.
// Parâmetros: int idxtexto
//-----------------------------------------------------------
...
//---------------------- FUNÇÃO: descricoesFunc ----------------------
// Função definida no sistema. Veja a implementação para detalhes.
// Parâmetros: int idxdescricoes,int modoseta
//-----------------------------------------------------------
...
//---------------------- FUNÇÃO: modoInput ----------------------
// Função genérica de input de valores numéricos com limite inferior e superior.
// Parâmetros: int valorAtual, int minimo, int maximo
//-----------------------------------------------------------
...
//---------------------- FUNÇÃO: modoInput ----------------------
// Função genérica de input de valores numéricos com limite inferior e superior.
// Parâmetros: valorAtual, minimo, maximo
//-----------------------------------------------------------
...
//---------------------- FUNÇÃO: menus ----------------------
// Função definida no sistema. Veja a implementação para detalhes.
// Parâmetros: int i, int b, int filho
//-----------------------------------------------------------
...
//====================== FUNÇÕES AUXILIARES ======================
//---------------------- FUNÇÃO: limparEEPROMFlags ----------------------
// Função definida no sistema. Veja a implementação para detalhes.
//-----------------------------------------------------------
void limparEEPROMFlags() {  // Função auxiliar definida pelo usuário
...
//====================== FUNÇÕES AUXILIARES ======================
//---------------------- FUNÇÃO: setupLuzMinMax ----------------------
// Função definida no sistema. Veja a implementação para detalhes.
//-----------------------------------------------------------
void setupLuzMinMax() {  // Função auxiliar definida pelo usuário
  int soma = 0;
...
//====================== FUNÇÕES AUXILIARES ======================
//---------------------- FUNÇÃO: monitoramentoDisplay ----------------------
// Função definida no sistema. Veja a implementação para detalhes.
//-----------------------------------------------------------
void monitoramentoDisplay() {  // Função auxiliar definida pelo usuário
...
// Função definida no sistema. Veja a implementação para detalhes.
//-----------------------------------------------------------
void debugEEPROM() {  // Função auxiliar definida pelo usuário
...
// Função definida no sistema. Veja a implementação para detalhes.
//-----------------------------------------------------------
void setup() {  // Função auxiliar definida pelo usuário
...
// Função definida no sistema. Veja a implementação para detalhes.
//-----------------------------------------------------------
void loop() {  // Função auxiliar definida pelo usuário
